...
const AddDistributorModal: React.FC<AddDistributorModalProps> = ({ onClose, onSuccess }) => {
        ...
        <div className="p-8">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl font-black text-on-surface uppercase tracking-tight">Thêm Nhà Phân Phối</h2>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-on-surface-variant uppercase flex items-center gap-2">
                <Building2 size={14} /> Tên Nhà Phân Phối (Distributor)
              </label>
              <input 
                required 
            ...
            <div className="space-y-2">
              ...
              <input 
                required 
                placeholder="Tên chủ NPP hoặc quản lý..."
                className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-primary/10 outline-none transition-all font-bold"
